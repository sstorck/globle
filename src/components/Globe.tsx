    ...
    <div>
      ...
      >
        <ReactGlobe
          ...
          polygonsData={places.filter((place) => return place.properties.TYPE !== "Territory";)}
          // @ts-ignore
          ...
          hexPolygonsData={places.filter((place) => return place.properties.TYPE === "Territory";)}
          hexPolygonColor={polygonColour}
          hexPolygonAltitude={getAltitude}
          hexPolygonLabel={getLabel}
          onHexPolygonClick={(p, e, c) => turn globe(c, globe ref);}
